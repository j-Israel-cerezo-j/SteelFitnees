function buildCardsImageGalery(json) {
    console.log({json})
        ...
        let html =
            `	<div id="divImage${i}" class="col-lg-2 col-md-2 col-sm-6 form-group justify-content-center" style="margin-top:15px">                                    
				    <div class="" style="width: 7.5rem;text-align:center;flex-direction:inherit">
				    	<img style="border-radius:30px;z-index:1" class="reflejo" id="image${i}" alt="Cargar fotografía por favor." src="${json[i].path}" height="280" width="250" />
                        <svg onclick="remremoveImag(${i})" style="cursor: pointer;z-index: 2;position: absolute;margin-left: -5px;margin-top: -95px;" width="45px" height="45px" viewBox="0 0 54 54" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
